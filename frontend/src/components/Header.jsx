...
const Header = memo(({ onMenuToggle, isMobileMenuOpen }) => {
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-xl h-10 w-10 overflow-hidden ring-2 ring-transparent hover:ring-primary/30 transition-all glow-effect p-0">
